...
<body style="background-color: ghostwhite">
    ...
    <div class="container">
        <h1 class="title-pages">Filtro por Usuário</h1>
        ...
        <asp:Button runat="server" CssClass="btn-pages" Text="Selecionar" ID="btnFiltroUser" OnClick="btnFiltroUser_Click" />
        <br />
        <br />
        ...
        <asp:Button runat="server" type="button" Text="Voltar" CssClass="btn-pages-s" ID="btnVoltar" OnClick="btnVoltar_Click"></asp:Button>
        <br />
        <br />
