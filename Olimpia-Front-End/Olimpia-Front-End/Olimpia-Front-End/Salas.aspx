...
<body style="background-color: ghostwhite">
    ...
    <div class="container" id="box3" style="display: none;">
        <div class="new-form">
            ...
            <asp:Button Text="Editar" runat="server" CssClass="btn-pages-s" ID="btnEditClass" OnClick="btnEditClass_Click" />
    ...
    <div class="container" id="box4" style="display: none">
        <div class="new-form">
            ...
            <asp:Button Text="Excluir" runat="server" CssClass="btn-pages-s" ID="btnDeleteClass" OnClick="btnDeleteClass_Click" />
