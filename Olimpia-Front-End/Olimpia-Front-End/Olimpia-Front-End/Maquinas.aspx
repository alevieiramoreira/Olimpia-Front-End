...
<body style="background-color: ghostwhite">
    ...
    <div class="container" id="box2" style="display: none;">
        <div class="new-form">
            ...
            <asp:Button Text="Visualizar" target="_blank" type="submit" CssClass="btn-pages-s" runat="server" ID="btnViewMachine" OnClick="btnViewMachine_Click" />
    ...
    <div class="container" id="box3" style="display: none;">
        <div class="new-form">
            ...
            <asp:Button Text="Salvar" runat="server" CssClass="btn-pages-s" ID="btnEditMachine" OnClick="btnEditMachine_Click" />
    ...
    <div class="container" id="box4" style="display: none">
        <div class="new-form">
            ...
            <asp:Button Text="Excluir" runat="server" CssClass="btn-pages-s" ID="btnDeleteMachine" OnClick="btnDeleteMachine_Click" />
    ...
    <div class="container" id="box5" style="display: none">
        <div class="new-form">
            ...
            <asp:Button Text="Cadastrar" runat="server" CssClass="btn-pages-s" ID="btnAddMachine" OnClick="btnAddMachine_Click" />
